...
class Ui_View(object):
    def setupUi(self, View):
        ...
        self.pcaIpnode_lineEdit = QtWidgets.QLineEdit(self.groupBox_4)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.pcaIpnode_lineEdit.setFont(font)
        self.pcaIpnode_lineEdit.setObjectName("pcaIpnode_lineEdit")
        self.gridLayout_5.addWidget(self.pcaIpnode_lineEdit, 0, 0, 1, 1)
        self.pcaIpnode_pushButton = QtWidgets.QPushButton(self.groupBox_4)
        self.pcaIpnode_pushButton.setObjectName("pcaIpnode_pushButton")
        self.gridLayout_5.addWidget(self.pcaIpnode_pushButton, 0, 1, 1, 1)
